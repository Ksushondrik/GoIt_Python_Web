...
async def refresh_token(credentials: HTTPAuthorizationCredentials = Depends(get_refresh_token), db: AsyncSession = Depends(get_db)):   # Security(get_refresh_token) == Depends(get_refresh_token)
